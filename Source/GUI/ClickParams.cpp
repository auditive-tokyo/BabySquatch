...
void BoomBabyAudioProcessorEditor::setupClickParams() {
  ...
  InfoBox::setInfo(clickUI.modeCombo, InfoText::clickMode);
  InfoBox::setInfo(clickUI.noise.decaySlider, InfoText::clickNoiseDecay);
  InfoBox::setInfo(clickUI.noise.bpf1.freqSlider, InfoText::clickBpfFreq);
  InfoBox::setInfo(clickUI.noise.bpf1.qSlider, InfoText::clickBpfQ);
  InfoBox::setInfo(clickUI.noise.bpf1.slopeSelector, InfoText::clickBpfSlope);
  InfoBox::setInfo(clickUI.noise.saturator.driveSlider, InfoText::clickDrive);
  InfoBox::setInfo(clickUI.noise.saturator.clipType, InfoText::clickClipType);
  InfoBox::setInfo(clickUI.hpf.slider, InfoText::clickHpfFreq);
  InfoBox::setInfo(clickUI.hpf.qSlider, InfoText::clickHpfQ);
  InfoBox::setInfo(clickUI.hpf.slope, InfoText::clickHpfSlope);
  InfoBox::setInfo(clickUI.lpf.slider, InfoText::clickLpfFreq);
  InfoBox::setInfo(clickUI.lpf.qSlider, InfoText::clickLpfQ);
  InfoBox::setInfo(clickUI.lpf.slope, InfoText::clickLpfSlope);
  InfoBox::setInfo(clickUI.sample.pitch.slider, InfoText::clickSamplePitch);
